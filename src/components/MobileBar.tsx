export default function MobileBar() {
  return (
    <div
      ...
      style={{ background: "#fff", borderTop: "1px solid #eae8e2", boxShadow: "0 -4px 20px rgba(0,0,0,0.08)" }}
    ...
    >
      <div className="flex">
        <a
          ...
          style={{ color: "#404e5e", textDecoration: "none", borderRight: "1px solid #eae8e2" }}
          aria-label="Fenetre Systems'ı ara"
        >
